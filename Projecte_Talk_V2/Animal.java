...
public class Animal {
    ...
    boolean talking() {
        ...
        while (PreguntaInicial != 'S') {
            ...
            if (PreguntaInicial != 83) {
                while (PreguntaInicial <= 64 || PreguntaInicial >= 72) {
          ...
          d'execució i memòria, però en aquest cas és la que m'ha funcionat*/
            switch (PreguntaInicial) {
                case 'A':
                    ...
                    while (lletraex9 <= 64 || lletraex9 >= 91) {
                ...
                case 'B':
                    ...
                    lletraex10 = teclat.next().charAt(0);
                    Verifiacio[2] = true;
                    while (lletraex10 <= 64 || lletraex10 >= 75) {
             ...
             */
                case 'C':
                    ...
                    while (lletraex11 <= 64 || lletraex11 >= 91) {
